...
if (strpos(json_encode($login), '"status":true')) {
    ...
    switch ($pilih) {
        ...
        default:
            echo @color('red', "PILIH PAKET INTERNET DULU\n\n\n");
            goto cek;
            break;
    }
    $cek = cek($prodid);
